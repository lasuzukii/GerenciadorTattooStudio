...
public class ListaTatuadores extends javax.swing.JDialog {

    private ArrayList<model.Tatuador> tatuadores;
    private java.awt.Frame parent;
    
    public ListaTatuadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        initComponents();
    ...
    private void preecherTabela() {
        ...
        Object[][] agendamenosT = new Object[this.tatuadores.size()][colunas.length];
        
        for(int i = 0; i < this.tatuadores.size(); i++){
            agendamenosT[i][0] = this.tatuadores.get(i).getId();
            agendamenosT[i][1] = this.tatuadores.get(i).getNome();
            agendamenosT[i][2] = this.tatuadores.get(i).getValor();
        }
    ...
    private void delete() {
        ...
        if (indexTable != -1) {
            ...
            if (option == 0) {
                try {
                    controller.TatuadorController.delete(this.tatuadores.get(indexTable));
                    this.tatuadores.remove(indexTable);
                    preecherTabela();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LISTA DE TATUADORES");
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        new CadastroTatuador(this.parent,true);
        this.tatuadores = controller.TatuadorController.getTatuador();
        preecherTabela();
